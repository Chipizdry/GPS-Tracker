...
class jeeui2
{
    StaticJsonDocument<16000> cfg;
    StaticJsonDocument<16000> pub_transport;
    StaticJsonDocument<16000> btn_transport;
  ...
  public:
    ...
    void textarea(String id, String label, bool readOnly);
    void save();
